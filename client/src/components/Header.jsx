...
const Header = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-20 px-4 text-center text-gray-800">
        ...
        {/* <p className="mb-8 max-w-md">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sit aperiam maxime, nobis dolores debitis necessitatibus.</p> */}
        <p className="mb-8 max-w-md">
  Welcome back! Manage your account, reset your password, and explore all the features built just for you.
</p>
